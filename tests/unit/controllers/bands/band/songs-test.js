...
test('canCreateSong', function(assert) {
	...
	assert.ok(controller.get('canCreateSong'), "Can't create song if process has started");
	...
	assert.ok(controller.get('canCreateSong'), "Can't create song if process has not started but there are already songs");
});
